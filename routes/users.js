...
router.get(`/`,async (req,res) => {
    const userList =await user.find().select('_passwordHash');
...
router.get('/:id', async (req,res) =>{
    const user =await User.findById(req.params.id).select('_passwordHash');
...
router.post('/login',async(req,res) =>{
    ...
    if(user && bcrypt.compareSync(req.body.password, this.use.passwordHash)){
